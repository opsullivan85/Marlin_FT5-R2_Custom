...
#define STRING_CONFIG_H_AUTHOR "(Owen Sullivan, Folgertech FT-5 R2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Owen's FT-5 R2"
...
#define Y_BED_SIZE 190 // Reduced because of my backwards mounded extruder
